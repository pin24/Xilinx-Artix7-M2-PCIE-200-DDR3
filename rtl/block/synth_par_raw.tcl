# ============================================================================
# synth_par_raw.tcl - синтез параллельного compute_dot_par_raw (NUM_MAC)
# ============================================================================
set proj_dir C:/A7_M2/EXAMPLES/XDMA_DDR3/rtl/block/synth_raw
set rtl_dir   C:/A7_M2/EXAMPLES/XDMA_DDR3/rtl/block
set npar 64

file mkdir ${proj_dir}
create_project -force par_raw_synth ${proj_dir} -part xc7a200tfbg484-2
