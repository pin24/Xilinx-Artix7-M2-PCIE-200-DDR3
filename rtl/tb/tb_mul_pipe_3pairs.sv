// ============================================================================
// tb_mul_pipe_3pairs.sv - подача 3 контрольных пар НЕПРЕРЫВНО (valid=1,1,1),
// запись всех выходов в файл с номером такта.
// ============================================================================
module tb_mul_pipe_3pairs;
    logic clk = 0, rst_n = 0;
    ...
    int c;
    initial begin
        fd_out = $fopen("sim/mulp3_out.hex", "w");
        rst_n = 0;
        repeat(3) @(posedge clk);
        rst_n = 1;
        // 3 пары непрерывно (valid не опускается между парами)
