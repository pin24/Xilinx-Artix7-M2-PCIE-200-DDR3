...
files = [f'{RTL}/rtl/tfloat_pkg.sv', f'{RTL}/rtl/int_to_trits.sv',
         f'{RTL}/rtl/tf40_to_f32.sv', f'{RTL}/rtl/tf40_mul_pipe.sv',
         f'{RTL}/rtl/tf40_add_pipe.sv', f'{RTL}/rtl/f32_to_tf40_pipe2.sv',
         f'{RTL}/rtl/compute_core_dot_pipe.sv', f'{RTL}/tb/{tb}.sv']
