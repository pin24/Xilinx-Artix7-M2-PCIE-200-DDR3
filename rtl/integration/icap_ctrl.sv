...
// (100 МГц для Artix-7), поэтому ICAPE2 тактируется делёным клоком.
// BUFGCE_DIV на Artix-7 не поддерживается — используем register-toggle + BUFG
// (/2 -> icap_clk = 62.5 МГц, см. секцию slow-домен ниже). Vivado создаёт
// generated clock автоматически.
