...
REM Copy the pre-built .cat from driver\build (generated by Inf2Cat or makecat)
copy /Y "%~dp0..\driver\build\XDMA.cat" "%BUILD_SYS%\XDMA.cat" >nul 2>&1
...
echo === Copying to driver\build for compatibility ===
copy /Y "%BUILD_SYS%\XDMA.sys"  "%~dp0..\driver\build\XDMA.sys" >nul 2>&1
copy /Y "%BUILD_SYS%\XDMA.cat"  "%~dp0..\driver\build\XDMA.cat" >nul 2>&1
copy /Y "%BUILD_SYS%\XDMA.cer"  "%~dp0..\driver\build\XDMA.cer" >nul 2>&1
copy /Y "%BUILD_SYS%\XDMA.inf"  "%~dp0..\driver\build\XDMA.inf" >nul 2>&1
copy /Y "%BUILD_EXE%\test_xdma.exe" "%~dp0..\driver\build\test_xdma.exe" >nul 2>&1
