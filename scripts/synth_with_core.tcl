# ============================================================================
# Build existing XDMA+DDR3 project (BD already generated) + троичное ядро
# Синтез всего проекта: XDMA + DDR3 + ядро dot (NUM_MAC=32).
# Run: vivado -mode batch -source scripts/synth_with_core.tcl
# ============================================================================
...
# ---- constraints (как в build_existing.tcl) ----
...
open_run synth_1
report_utilization -file ${proj_dir}/scripts/util_with_core.rpt
report_utilization -hierarchical -file ${proj_dir}/scripts/util_with_core_hier.rpt
close_design
