...
| **Статус** | ✅ Точность исправлена (модельный уровень). ⚠️ Тайминг НЕ закрыт: модуль остался однотактным, в сборку НЕ подключён; перед включением в файлсет — пайплайн 16–20 стадий (см. BUG-037/BUG-038), иначе WNS-гейт справедливо уронит сборку |
